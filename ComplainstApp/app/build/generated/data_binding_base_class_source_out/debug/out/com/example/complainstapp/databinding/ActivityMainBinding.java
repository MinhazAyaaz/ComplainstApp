...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull AutoCompleteTextView autoCompleteTextView, @NonNull Button elevatedButton,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.elevatedButton;
      Button elevatedButton = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, autoCompleteTextView,
          elevatedButton, imageView3, textView);
    }
